...
BEGIN
  FOR r IN
    SELECT * FROM (VALUES
      ...
      -- Fiche de preparation au canevas EPST : identification complete
      -- (sous-branche, methode, reference au programme, duree, effectif) et
      -- deroulement en etapes nommees, plus le visa du chef d'etablissement.
...
WITH attendu(tbl, col) AS (
  VALUES
    ...
    ('conduct','trimestre'),
    ('conduct','school_id'),
    ('cahier_prep','sous_branche'),
    ('cahier_prep','methode'),
    ('cahier_prep','reference'),
    ('cahier_prep','duree'),
    ('cahier_prep','effectif'),
    ('cahier_prep','revision'),
    ('cahier_prep','motivation'),
    ('cahier_prep','synthese'),
    ('cahier_prep','visa_by'),
    ('cahier_prep','visa_date'),
